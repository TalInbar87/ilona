...
המערכת מכילה מידע רפואי רגיש ונכנסת לתחולת **תקנות הגנת הפרטיות (אבטחת מידע) תשע"ז-2017** — רמת אבטחה בינונית לפחות.

**כל** שינוי — קוד, מסד נתונים, storage, תשתית — חייב לעמוד בסטנדרטים הבאים.

### פערים ידועים לטיפול עתידי (לא טכני — ארגוני)
- תיעוד אירועי אבטחה — אין תהליך מוגדר
- לוג גישה למידע — אין תיעוד "מי ניגש למה ומתי"
- נהלי אבטחה כתובים — אין מסמך פנימי
- הדרכת משתמשים על חוקי פרטיות — אין תיעוד
- סקירת נהלים שנתית — אין תהליך מוגדר
