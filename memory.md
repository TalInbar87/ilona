...
## 2026-06-24 — דשבורד/מובייל + POC אבחונים (נגנז)
...
### אבחונים — POC כתיבה ידנית בעט ❌ נגנז (2026-06-24, נמחק מהקוד)

**הוחלט לגנוז** — המגבלות של כתב יד + אורך השדות בטפסים האמיתיים לא מתאימים לגישת ה-canvas. נמחקו כל הקבצים (handwriting.ts, HandwritingCanvas.tsx, generateDiagnosticPdf.ts, DiagnosticsPocPage.tsx) + route + nav. הקוד נשמר ב-git history (commit `5ece211`) אם יידרש בעתיד.

**מה נלמד (לעתיד אם חוזרים לזה):**
- כתב יד כוקטור (strokes `[x,y,pressure]`) אכן קומפקטי (KB בודדים לשדה) ועברית "עובדת" כי זה ציור
- אבל: לא ניתן לחפש תוכן, וטפסים ארוכים עם הרבה טקסט לא פרקטיים בכתב יד
- Apple Scribble (המרת עברית לטקסט) עדיין לא ברמה מספקת
- מסקנה: אבחונים דיגיטליים יצטרכו גישה אחרת (שדות טקסט מובְנים / בחירות), לא חיקוי דף נייר

---

<details>
<summary>ארכיון — פרטי ה-POC שנגנז</summary>
