...
export function PatientsPage() {
  ...
  const { data: patients, loading, refetch } = usePatients(debouncedSearch) as any;
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{patients?.length ?? 0} מטופלים</p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="card p-12 text-center">
          ...
          <p className="text-gray-400">לא נמצאו מטופלים</p>
        </div>
      ) : (
